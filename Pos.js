...
const Pos = {
  ...
  <thead>
    <tr>
      ...
      <td><img id="image" src="紅茶.jpg"alt="飲料照片" >
      <td>
  ...
  Pos.calcPrice = function () {
    ...
    if(a=="紅茶:35"){document.getElementById("image").src = "紅茶.jpg";}
    if(a=="綠茶:35"){document.getElementById("image").src = "綠茶.jpg";}
    if(a=="鮮奶茶:50"){document.getElementById("image").src = "鮮奶茶.jpg";}
    if(a=="巧克力可可:60"){document.getElementById("image").src = "巧克力可可.jpg";}
